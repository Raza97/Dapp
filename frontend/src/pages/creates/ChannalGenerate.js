...
import ChanalCreation from "../../components/Cards/ChanalCreation";

const ChannalGenerate = () => {
  ...
  return (
    <>
      ...
      {/* <div className="pageIdentify mt-[35rem]">Settings</div>
...
export default ChannalGenerate;
